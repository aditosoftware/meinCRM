var colname = a.askQuestion("Bitte gewünschten Bezeichnernamen eingeben:", a.QUESTION_EDIT, "");
...
if(colname != null)
{
    ...
    if(isKey)
    {
        var s = "Der gewählte Spaltenname ist ein reserviertes Wort für:\n";
    ...
    {
        a.showMessage("Der gewählte Bezeichner ist nach derzeitigem Stand kein reserviertes Wort.");
    }
}